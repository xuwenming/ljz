		...
		<form id="form" method="post">		
			...
			<table class="table table-hover table-condensed">
				<tr>	
					...
					<td>
					<input class="span2" name="addtime" type="text" onclick="WdatePicker({dateFmt:'<%=TljzGoods.FORMAT_ADDTIME%>'})"  maxlength="0" class="required " />
					</td>							
					<th><%=TljzGoods.ALIAS_UPDATETIME%></th>	
					<td>
					<input class="span2" name="updatetime" type="text" onclick="WdatePicker({dateFmt:'<%=TljzGoods.FORMAT_UPDATETIME%>'})"  maxlength="0" class="required " />
					</td>							
				</tr>	
				<tr>	
				...
				<tr>	
					...
					<td>
											<input class="span2" name="imageUrl" type="text"/>
					</td>							
				</tr>	
				<tr>	
					<th><%=TljzGoods.ALIAS_DESCRIBTION%></th>	
					<td>
											<input class="span2" name="describtion" type="text"/>
					</td>							
					<th><%=TljzGoods.ALIAS_IS_PUT_AWAY%></th>	
					<td>
											<input class="span2" name="isPutAway" type="text"/>
					</td>							
				</tr>	
				<tr>	
					<th><%=TljzGoods.ALIAS_LIMIT_NUMBER%></th>	
					<td>
											<input class="span2" name="limitNumber" type="text"/>
					</td>							
				...
				<tr>	
					...
					<td>
											<input class="span2" name="shareAmount" type="text"/>
					</td>							
					<th><%=TljzGoods.ALIAS_PRIZE_PRE%></th>	
					<td>
											<input class="span2" name="prizePre" type="text"/>
					</td>							
				</tr>	
				<tr>	
					<th><%=TljzGoods.ALIAS_PRIZE_AMOUNT%></th>	
					<td>
											<input class="span2" name="prizeAmount" type="text"/>
					</td>							
					<th><%=TljzGoods.ALIAS_PRIZE_NUMBER%></th>	
					<td>
											<input class="span2" name="prizeNumber" type="text"/>
					</td>							
				</tr>	
			</table>		
		</form>
